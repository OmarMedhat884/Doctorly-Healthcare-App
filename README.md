...
- 🛠️ [**View the Behance**](https://www.behance.net/gallery/239969517/Doctorly-Medical-Application)
...
- Organized electronic medical records  
...
- Analyze the healthcare market and existing platforms (e.g., Vezeeta)  
- Identify key user needs: booking, doctor search, telemedicine, medical records  
...
- Map user journeys: booking visits, consulting doctors, ordering medication  

### **4. Wireframing**
- Create low-fidelity wireframes for both website and mobile app  
- Focus on layout, user flow, and intuitive navigation  

### **5. UI Design (High-Fidelity)**
- Build a consistent visual identity (colors, typography, icons, medical theme)  
- Design high-fidelity mockups for all screens  

### **6. Prototyping**
- Develop interactive prototypes using Figma  
- Simulate core flows such as booking, video consultation, and pharmacy orders  

### **7. Testing & Feedback**
- Conduct usability tests with users or peers  
- Evaluate clarity, flow efficiency, and ease of use  
- Refine designs based on insights to enhance accessibility and experience  

### **8. Final Presentation & Documentation**
- Prepare a professional final presentation (slides + Behance case study)  
- Submit prototype, personas, journey maps, wireframes, and full design system  
